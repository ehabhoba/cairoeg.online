...
const ClientSidebar: React.FC<ClientSidebarProps> = ({ currentRoute }) => {
                ...
                {navItems.map(item => {
                    ...
                    return (
                        <button 
                            ...
                            className={`w-full text-right flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-semibold transition-colors ${
                                isActive 
