            ...
            <div className="max-w-md w-full">
                ...
                <div className="bg-slate-800/50 p-8 rounded-2xl border border-slate-700/50 shadow-lg">
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        <div>
                            <label htmlFor="phone-number" className="block text-sm font-medium text-slate-300 mb-1">رقم الهاتف</label>
                            <input
                                id="phone-number"
                                name="phone"
                                type="tel"
                        ...
                        <div className="flex items-center justify-between text-sm">
                             <button type="button" onClick={() => navigate('/register')} className="font-medium text-primary hover:text-primary/90">
                                ليس لديك حساب؟ سجل الآن
                            </button>
                            <button type="button" onClick={() => navigate('/forgot-password')} className="font-medium text-primary hover:text-primary/90">
                                نسيت كلمة المرور؟
                            </button>
                        </div>
