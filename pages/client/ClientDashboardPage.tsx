            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div className="bg-panel-bg p-6 rounded-2xl border border-slate-100/10 shadow-lg flex items-start justify-between">
                        <div>
                            <p className="text-sm font-medium text-slate-400">المشاريع النشطة</p>
                    ...
                    <div className="bg-panel-bg p-6 rounded-2xl border border-slate-100/10 shadow-lg flex items-start justify-between">
                        <div>
                            <p className="text-sm font-medium text-slate-400">الفواتير المستحقة</p>
                            <p className="text-3xl font-bold text-white mt-1">{unpaidInvoices}</p>
                        </div>
                         <div className="w-12 h-12 flex items-center justify-center bg-gold/20 text-gold rounded-lg">
                            <InvoiceIcon />
                        </div>
                    </div>
                </div>
                        ...
                        {latestProject ? (
                            <div>
                                <div className="flex justify-between items-center">
                                    <h4 className="font-semibold text-slate-200">{latestProject.name}</h4>
