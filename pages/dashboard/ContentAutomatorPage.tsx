...
const ContentAutomatorPage: React.FC = () => {
    ...
    const handleGenerate = async () => {
        ...
        const prompt = `أنت كاتب محتوى متخصص في التسويق الرقمي لدى وكالة "إعلانات القاهرة". اكتب مقالًا احترافيًا ومُحسَّنًا لمحركات البحث (SEO) باللغة العربية حول الموضوع التالي: "${topic}".
المقال يجب أن يتضمن:
1.  عنوان جذاب ومباشر.
2.  مقدمة شيقة تعرض المشكلة أو الفكرة.
3.  عدة فقرات تستخدم عناوين فرعية واضحة (باستخدام ###).
4.  خاتمة تلخص النقاط الرئيسية وتحتوي على دعوة للعمل (Call to Action) للتواصل مع "إعلانات القاهرة" للمزيد من الخدمات الاحترافية عبر موقعهم https://cairoeg.online/.
